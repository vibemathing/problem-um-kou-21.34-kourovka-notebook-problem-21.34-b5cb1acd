...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kou-21.34-kourovka-notebook-problem-21.34-b5cb1acd-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KOU-21.34"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kou-21.34-kourovka-notebook-problem-21.34-b5cb1acd-v1",
      "problem_contract_sha256": "752febad70e37278f7b81ec34b13b77b240d0f6e68cd6246512c05bef91a60fe",
      "problem_id": "problem:um-kou-21.34-kourovka-notebook-problem-21.34-b5cb1acd",
      "route_id": "route:um-kou-21.34-kourovka-notebook-problem-21.34-b5cb1acd-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kou-21.34-kourovka-notebook-problem-21.34-b5cb1acd-source-fidelity-01",
      "graph_id": "graph:um-kou-21.34-kourovka-notebook-problem-21.34-b5cb1acd-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kou-21.34-kourovka-notebook-problem-21.34-b5cb1acd-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kou-21.34-kourovka-notebook-problem-21.34-b5cb1acd-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "(Well-known problem). A group $G$ is a unique product group if, for any nonempty finite subsets $A,B$ of $G$, there exists an element of $G$ which can be written uniquely as $ab$ with $a\\in A$ and $b\\in B$. A group $G$ is locally invariant orderable if $G$ admits a partial order $<$ such that for all $g,h\\in G$ with $h\\ne 1$, we have either $gh>g$ or $gh^{-1}>g$. Does there exist a unique product group which is not locally invariant orderable?"
          },
          "statement_sha256": "732e66f115d3d72026106a92bcafa0bf64fc40b1b83f603ad0a855e8dd7bc574"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kou-21.34-kourovka-notebook-problem-21.34-b5cb1acd-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kou-21.34-kourovka-notebook-problem-21.34-b5cb1acd-root",
      "route_id": "route:um-kou-21.34-kourovka-notebook-problem-21.34-b5cb1acd-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kou-21.34-82efa4c4d816",
        "url": "https://www.unsolvedmath.com/problems/KOU-21.34"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
